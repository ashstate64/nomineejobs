...
const articles = [
  {
    slug: 'how-to-become-nominee-director-uk-2026',
    title: 'How to Become a Nominee Director in the UK: Complete 2026 Guide',
  ...
  {
    slug: 'nominee-director-salary-uk-2026',
  ...
  {
    slug: 'uk-company-law-changes-2026-nominee-directors',
    title: 'New UK Company Law Changes: What Nominee Directors Need to Know in 2026',
    description: 'Comprehensive guide to the latest UK company law changes (ECCTA) affecting nominee directors, including new identity verification requirements.',
    date: '2026-03-01',
    readTime: '8 min read',
